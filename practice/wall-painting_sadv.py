...
print('How many walls do you want to paint')
num_walls = int(input())
for i in range(num_walls):
    print('What is the width of the wall ' + str(i) + '?')
    width = float(input())
    print('What is the height of the wall ' + str(i) + '?')
    height = float(input())
    sum_area += width * height
print('How much does a gallon of paint cost?')
price_gallon = float(input())
print('How many coats do you want to apply?')
num_coats = int(input())

#3. Transform
num_used_gallons = num_coats * sum_area / COVERS
